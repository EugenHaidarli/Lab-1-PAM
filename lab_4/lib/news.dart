                                            ...
                                            children: <Widget>[
                                                ...
                                                children: <Widget>[
                                                  Container(
                                                    ...
                                                    child: ClipRRect(
                                                      ...
                                                      child: Image.network(dataList[1][index]["portal"]["logo"], width: 16, height: 16, fit: BoxFit.cover),
                                                    ),
                                                  ),
                                                  Container(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Container(
                                                      margin: const EdgeInsets.fromLTRB(0, 0, 18.67, 0),
                                                      child: Text(
                                                          NumberFormat.compact().format(dataList[1][index]["likes"]).toString(),
                                                          style:
                                                              const TextStyle(
                                                                  fontSize: 10,
                                                                  color: Color.fromRGBO(44, 58, 75, 1)))),
                                                  ...
                                                  Container(
                                                      ...
                                                      child: Text(
                                                          NumberFormat.compact().format(dataList[1][index]["comments"]).toString(),
                                                          style:
                                                              const TextStyle(
                                                                  fontSize: 10,
                                                                  color: Color.fromRGBO(44, 58, 75, 1)))),
