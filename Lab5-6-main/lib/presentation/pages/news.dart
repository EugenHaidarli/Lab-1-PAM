                                    ...
                                    child: Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: <Widget>[
                                            ...
                                            Flexible(
                                                child: Container(
                                                    margin: const EdgeInsets.fromLTRB(16, 24, 24, 16),
                                                    child: Column(
                                                      mainAxisAlignment:
                                                          MainAxisAlignment.spaceBetween,
                                                      children: <Widget>[
                                                        Text(posts.welcomes[index].title,
                                                          overflow: TextOverflow.ellipsis,
                                                          maxLines: 2,
                                                          style:
                                                              const TextStyle(
                                                          ...
                                                          children: <Widget>[
                                                            Container(
                                                              ...
                                                              child: ClipRRect(
                                                                ...
                                                                child: Image.network(posts.welcomes[index].author.avatar,
                                                                    width: 16,
                                                                    height: 16,
                                                                    fit: BoxFit.cover),
                                                              ),
                                                            ...
                                                            Container(
                                                              ...
                                                              child: Text(posts.welcomes[index].author.name,
                                                                style: const TextStyle(
                                                                    fontWeight: FontWeight.bold,
                                                                    fontSize: 10,
                                                                    color: Color.fromRGBO(44, 58, 75, 1)),
                                                            ...
                                                            Container(
                                                              ...
                                                              child: Text(posts.welcomes[index].category.title,
                                                                style: const TextStyle(
                                                                    fontWeight: FontWeight.bold,
                                                                    fontSize: 9,
                                                                    color: Color.fromRGBO(255, 104, 97, 1)),
                                                        ...
                                                        Row(
                                                          ...
                                                          children: <Widget>[
                                                            ...
                                                            Container(
                                                                margin:
                                                                    const EdgeInsets.fromLTRB(0, 0, 18.67, 0),
                                                                child: Text(
                                                                    NumberFormat.compact().format(posts.welcomes[index].viewsCount).toString(),
                                                                    style: const TextStyle(
                                                                        fontSize: 10,
                                                                        color: Color.fromRGBO(44, 58, 75, 1)))),
                                                            Container(
                                                            ...
                                                            Container(
                                                                ...
                                                                child: Text(
                                                                    NumberFormat.compact()
                                                                        .format(posts.welcomes[index].viewsCount).toString(),
                                                                    style: const TextStyle(
                                                                        fontSize: 10,
                                                                        color: Color.fromRGBO(44, 58, 75, 1)))),
                                                            Image.asset(
